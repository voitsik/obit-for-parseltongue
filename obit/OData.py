...
class OData(Obit.OData):
    ...
    def NewTable(
        ...
        * maxis1-5  = Dimension of axes of IDI data matrix
        ...
        if tabType == "AIPS AN":
            outTable.me = Obit.TableAN(
                id, tver, access, tabType, numIF, numOrb, numPCal, err.me
            )
            ...
            outTable.me = Obit.TableCL(
                id, tver, access, tabType, numPol, numIF, numTerm, err.me
            )
        elif tabType == "AIPS BP":
            outTable.me = Obit.TableBP(
                id, tver, access, tabType, numPol, numIF, numChan, err.me
            )
        elif tabType == "AIPS PD":
            outTable.me = Obit.TablePD(
                id, tver, access, tabType, numPol, numIF, numChan, err.me
            )
        elif tabType == "AIPS BL":
            outTable.me = Obit.TableBL(id, tver, access, tabType, numPol, numIF, err.me)
        elif tabType == "AIPS PC":
            outTable.me = Obit.TablePC(
                id, tver, access, tabType, numPol, numTones, err.me
            )
            ...
            outTable.me = Obit.TableGC(
                id, tver, access, tabType, numBand, numPol, numTabs, err.me
            )
        elif tabType == "AIPS MC":
            outTable.me = Obit.TableMC(
                id, tver, access, tabType, numPol, numBand, err.me
            )
            ...
            outTable.me = Obit.TableCP(
                id, tver, access, tabType, numIF, numChan, err.me
            )
        elif tabType == "AIPS CQ":
            outTable.me = Obit.TableCQ(id, tver, access, tabType, numIF, err.me)
        elif tabType == "AIPS IM":
            outTable.me = Obit.TableIM(
                id, tver, access, tabType, numPol, numBand, npoly, err.me
            )
            ...
            outTable.me = Obit.TableIDI_ANTENNA(
                id, tver, access, tabType, numIF, numPCal, err.me
            )
        elif tabType == "IDI_ARRAY_GEOMETRY":
            outTable.me = Obit.TableIDI_ARRAY_GEOMETRY(
                id, tver, access, tabType, numIF, numOrb, err.me
            )
        elif tabType == "IDI_FREQUENCY":
            outTable.me = Obit.TableIDI_FREQUENCY(
                id, tver, access, tabType, numIF, err.me
            )
        elif tabType == "IDI_SOURCE":
            outTable.me = Obit.TableIDI_SOURCE(id, tver, access, tabType, numIF, err.me)
        elif tabType == "IDI_OData_DATA":
            outTable.me = Obit.TableIDI_OData_DATA(
                id,
                tver,
                access,
                tabType,
            ...
            ret = Obit.newODataTable(
                inOData.cast(myClass).me, access, tabType, tver, err.me
            )
        ...
        if not outTable.IsA():
            ...
            raise RuntimeError(
                "Failed to extract " + tabType + " table from " + inOData.GetName()
            )
        # Error?
        if err.isErr:
            OErr.printErrMsg(err, "Error getting OData data Table")
    ...
    def CopyTables(self, outOData, exclude, include, err):
        ...
        * err       = Python Obit Error/message stack
        ...
        if not OErr.OErrIsA(err):
            raise TypeError("err MUST be an OErr")
        #
        ret = Obit.ODataCopyTables(
            self.cast(myClass).me, outOData.cast(myClass).me, exclude, include, err.me
        )
        if err.isErr:
    ...
    def IsScratch(self):
        """
        Tell if OData is a scratch object.
    ...
    def ODataIsA(self):
        """
        Tell if input really a Python Obit OData.
