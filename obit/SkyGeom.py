...
def PWorldPos(
    xpix, ypix, xref, yref, xrefpix, yrefpix, xinc, yinc, rot, type, xpos, ypos
):
    ...
    """
    ################################################################
    return Obit.SkyGeomWorldPos(
        xpix, ypix, xref, yref, xrefpix, yrefpix, xinc, yinc, rot, type, [0.0], [0.0]
    )
    # end PWorldPos


def PCDpos(xpix, ypix, xref, yref, xrefpix, yrefpix, xinc, yinc, rot, cd1, cd2, type):
...
def PXYpix(xpos, ypos, xref, yref, xrefpix, yrefpix, xinc, yinc, rot, type):
    ...
    """
    ################################################################
    return Obit.SkyGeomXYpix(
        xpos, ypos, xref, yref, xrefpix, yrefpix, xinc, yinc, rot, type, [0.0], [0.0]
    )
    # end PXYpix


def PCDpix(xpos, ypos, xref, yref, xrefpix, yrefpix, xinc, yinc, rot, icd1, icd2, type):
...
def PWorldPosLM(dx, dy, xref, yref, xinc, yinc, rot, type):
    ...
    """
    ################################################################
    return Obit.SkyGeomWorldPosLM(
        dx, dy, xref, yref, xinc, yinc, rot, type, [0.0], [0.0]
    )
    # end PWorldPosLM
...
def PXYPixLM(xpos, ypos, xref, yref, xinc, yinc, rot, type, dx, dy):
    ...
    """
    ################################################################
    return Obit.SkyGeomXYPixLM(
        xpos, ypos, xref, yref, xinc, yinc, rot, type, [0.0], [0.0]
    )
    # end PXYPixLM
