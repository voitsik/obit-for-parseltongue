...
static void FindTabBeam(ObitBeamShape *in)
{
    ...
    switch (itab) {
        case 0:     /* P band */
            ...
            for (j = 0; j < Pncell; j++)
                tFA->array[j] = Pbeam[j] * Pbeam[j]; /* Voltage to power */
        ...
        case 1:     /* S band */
            ...
            for (j = 0; j < Sncell; j++)
                tFA->array[j] = Sbeam[j] * Sbeam[j]; /*  Voltage to power */
    ...
    switch (itab) {
        case 0:     /* 1.35 GHz beam */
            ...
            ofloat MKbeam[] = {    /* Fitted to voltage beam */
                ...
                0.929591, 0.924946, 0.920166, 0.915252, 0.910205, 0.905028, 0.899722, 0.894288, 0.888729, 0.883045,
