...
gboolean ObitInfoElemComp(const ObitInfoElem *me, ObitInfoType type, const gint32 *dim);
...
void ObitInfoElemResize(ObitInfoElem *me, ObitInfoType type, const gint32 *dim);
